...
const SCENARIOS = {
  valid: {
    ...
    subject:     "A. Novak",               // hashed — no full PII
    subjectHash: "sha256:3fa9b…c812",
    issuer:      "University of Ljubljana",
    issuerDid:   "did:ebsi:uni-lj-2024-01",
    issuedOn:    "22 Jan 2025",
    algorithm:   "Ed25519",
    ebsiTxHash:  "0x3fa9b1c2d3e4f5…c812",
    ects:        4,
    disclosed:   ["Title","Issuer","ECTS credits","Issue date"],
    result:      "valid",
  },
  revoked: {
    code:        "EDX-7700-XX11",
  ...
  unknown: {
    ...
    issuerDid:   "did:example:unknown-issuer",
    issuedOn:    "—",
    algorithm:   "RSA-2048",
    ebsiTxHash:  null,
    ects:        null,
...
// Verification steps (طبق user-flow سند ۱۶)
const VSTEPS = [
